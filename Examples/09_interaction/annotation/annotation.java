...
public class annotation {
    ...
    static float addFreeTextAnnotation(PdfPageBase page, float y) {
        ...
        annotation.setAnnotationIntent(PdfAnnotationIntent.Free_Text_Callout);
        ...
        annotation.setLineEndingStyle(PdfLineEndingStyle.Open_Arrow);
    ...
    static float addLineAnnotation(PdfPageBase page, float y) {
        ...
        annotation.setBeginLineStyle(PdfLineEndingStyle.Closed_Arrow);
        annotation.setEndLineStyle(PdfLineEndingStyle.Closed_Arrow);
